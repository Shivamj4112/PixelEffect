...
public class Filter_Adapter extends RecyclerView.Adapter<Filter_Adapter.EffectHolder> {

    Activity activity;
    String[] filter_name;

    public Filter_Adapter(PhotoEditingActivity photoEditingActivity, String[] filter_name) {
    ...
    public void onBindViewHolder(@NonNull EffectHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PhotoEditingActivity.Filter(position1);
