...
public class RotaionMultitouch implements OnTouchListener {
    ...
    private Rect rect;
    private com.effect.pixeleffect.Multitouch.ScaleGestureDetector mScaleGestureDetector;
    ...
    public RotaionMultitouch(boolean isRotateEnabled, boolean isTranslateEnabled, boolean isScaleEnabled) {
        ...
        mScaleGestureDetector = new com.effect.pixeleffect.Multitouch.ScaleGestureDetector(new ScaleGestureListener());
    ...
    private class ScaleGestureListener extends com.effect.pixeleffect.Multitouch.ScaleGestureDetector.SimpleOnScaleGestureListener {

        private float mPivotX;
        private float mPivotY;
        private com.effect.pixeleffect.Multitouch.Vector2D mPrevSpanVector = new com.effect.pixeleffect.Multitouch.Vector2D();

        @Override
        public boolean onScaleBegin(View view, com.effect.pixeleffect.Multitouch.ScaleGestureDetector detector) {
        ...
        @Override
        public boolean onScale(View view, com.effect.pixeleffect.Multitouch.ScaleGestureDetector detector) {
            TransformInfo info = new TransformInfo();
            info.deltaScale = isScaleEnabled ? detector.getScaleFactor() : 1.0f;
            info.deltaAngle = isRotateEnabled ? com.effect.pixeleffect.Multitouch.Vector2D.getAngle(mPrevSpanVector, detector.getCurrentSpanVector()) : 0.0f;
